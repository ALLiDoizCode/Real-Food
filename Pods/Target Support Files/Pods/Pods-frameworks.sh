...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/FXImageView.framework"
  install_framework "Pods/HanabiCollectionViewLayout.framework"
  install_framework "Pods/KIChameleonView.framework"
  install_framework "Pods/Parse.framework"
  install_framework "Pods/Reachability.framework"
  install_framework "Pods/SDWebImage.framework"
  install_framework "Pods/VKFoundation.framework"
  install_framework "Pods/VKVideoPlayer.framework"
fi
