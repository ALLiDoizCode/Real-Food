...
class GetImage {
    ...
    func getImage(viewController:UIViewController,theController:UIImagePickerController,completion:(image:UIImage) -> Void) {
        ...
        let presentImagePickerController: UIImagePickerControllerSourceType -> () = { source in
            ...
            viewController.presentViewController(theController, animated: true, completion: nil)
        }
